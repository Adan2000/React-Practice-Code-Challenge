...
//make a fetch to an api, store that data in state

2. Only 4 sushi are rendered at a time

//make a function that limits to only render 4 sushis
...
//make another function that renders the next 4 sushis
